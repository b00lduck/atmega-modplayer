...
#define configure_pin_ss() DDRC |= (1 << 0)
#define configure_pin_miso() DDRB &= ~(1 << 6)

#define select_card() PORTC &= ~(1 << 0)
#define unselect_card() PORTC |= (1 << 0)

#define configure_pin_available() /* nada */
#define configure_pin_locked() /* nada */ 
